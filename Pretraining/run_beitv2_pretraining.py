...
def main(args):
    ...
    wandb.init(project = "BEiT for object detection",config = dict(
    epochs=6,
    Model = str(model_without_ddp),
    number_of_params= n_parameters,
    Tokenizer = str(vqkd),
    LR = args.lr,
    Batch_size = total_batch_size,
    Number_of_training_steps = num_training_steps_per_epoch,
    Patch_size = str(patch_size),
    epoch = args.epochs,
    Number_of_training_examples_per_epoch = (total_batch_size * num_training_steps_per_epoch)))
